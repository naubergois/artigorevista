...
\begin{tabular}[c]{@{}l@{}}\begin{minipage}{0.1\textwidth}\scriptsize Hybrid\\ Metaheuristic\end{minipage}\end{tabular}  & \cellcolor[HTML]{FFCCC9} & \cellcolor[HTML]{FFCCC9} & \cellcolor[HTML]{F8FF00} \begin{minipage}{0.2\textwidth} GOIS, 2015 \end{minipage}  \\ \cline{2-4} 
GA                                                              & \cellcolor[HTML]{CD9934} \begin{minipage}{0.12\textwidth}\scriptsize Alander,1998 \cite{Alander} \\ Wegener, 1996 and 1997 \cite{Wegener1997}\cite{J.WegenerK.GrimmM.GrochtmannH.Sthamer1996}\end{minipage} & \cellcolor[HTML]{CD9934} & \cellcolor[HTML]{CD9934} \\ \cline{2-4} 
